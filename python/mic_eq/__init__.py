...
try:
    ...
    try:
        # Keep the top-level fallback for compatibility with environments that
        # expose the native module outside the package namespace.
        from mic_eq_core import (  # type: ignore[reportMissingImports]
            AudioProcessor,
            DeviceInfo,
            list_input_devices,
            list_output_devices,
