...
class Preset:
    ...
    name: str = "Default"
    description: str = ""
    version: str = "1.8.2"  # Version field for migration
    ...
    def from_dict(cls, data: dict) -> 'Preset':
        ...
        try:
            ...
            # Migrate v1.7.4 presets -> v1.8.0 (no format changes)
            if version_tuple < _version_tuple('1.8.0'):
                data['version'] = '1.8.0'
                version_tuple = _version_tuple('1.8.0')

            # Migrate v1.8.0 presets -> v1.8.1 (no format changes)
            if version_tuple < _version_tuple('1.8.1'):
                data['version'] = '1.8.1'
                version_tuple = _version_tuple('1.8.1')

            # Migrate v1.8.1 presets -> v1.8.2 (no format changes)
            if version_tuple < _version_tuple('1.8.2'):
                data['version'] = '1.8.2'
                version_tuple = _version_tuple('1.8.2')
            ...
            return cls(
                ...
                version=data.get('version', '1.8.2'),
                gate=validated_gate,
                eq=validated_eq,
